...
/datum/martial_art/psychotic_brawling/proc/psycho_attack(mob/living/attacker, mob/living/defender, grab_attack)
	...
	switch(rand(1,8))
		...
		if(4)
			...
			apply_hyper_martial_damage(attacker, defender, defender_damage, attacker.get_attack_type(), BODY_ZONE_HEAD)
		...
		if(5,6)
			...
			apply_hyper_martial_damage(attacker, defender, rand(15, 30), attacker.get_attack_type())
