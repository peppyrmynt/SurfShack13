...
/datum/supply_pack/security/armory/wt550ammo
	...
	desc = "Contains four 20-round magazine for the WT-550 Auto Rifle. Each magazine is designed to facilitate rapid tactical reloads."
	cost = CARGO_CRATE_VALUE * 4
...
/datum/supply_pack/security/combatknives
	...
	desc = "Contains three sharpened combat knives. Each knife guaranteed to fit snugly inside any Nanotrasen-standard boot."
	cost = CARGO_CRATE_VALUE * 4.5
...
/datum/supply_pack/security/armory/lethalammo
	name = "Lethal Ammo Crate"
	desc = "Contains two boxes of shotgun slugs and two boxes of buckshot shotgun shells."
	cost = CARGO_CRATE_VALUE * 8
	access_view = ACCESS_ARMORY
	contains = list(/obj/item/storage/box/lethalshot = 2,
					/obj/item/storage/box/slugs = 2
				)
	crate_name = "lethal ammo crate"
