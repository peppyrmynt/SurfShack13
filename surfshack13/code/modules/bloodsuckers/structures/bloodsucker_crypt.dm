...
/obj/structure/bloodsucker/vassalrack
	...
	icon = 'surfshack13/icons/bloodsuckers/vamp_obj.dmi'
...
/obj/structure/bloodsucker/bloodthrone
	...
	icon = 'surfshack13/icons/bloodsuckers/vamp_obj_64.dmi'
	icon_state = "throne"
	buckle_lying = 0
	anchored = FALSE
	density = TRUE
...
/obj/structure/bloodsucker/bloodthrone/proc/GetArmrest()
	return mutable_appearance('surfshack13/icons/bloodsuckers/vamp_obj_64.dmi', "thronearm")
