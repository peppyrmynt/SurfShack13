/datum/antagonist/bloodsucker
	...
	hijack_speed = 0.5
	hud_icon = 'surfshack13/icons/bloodsuckers/bloodsucker_icons.dmi'
...
/datum/antagonist/bloodsucker/greet()
	...
	owner.current.playsound_local(null, 'surfshack13/sound/bloodsuckers/BloodsuckerAlert.ogg', 100, FALSE, pressure_affected = FALSE)
