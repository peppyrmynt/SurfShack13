...
/obj/machinery/nanite_chamber
	...
	icon = 'surfshack13/nanites/icons/nanite_machines.dmi'
	...
	var/chamber_icon = 'surfshack13/nanites/icons/nanite_chamber.dmi'
...
/obj/machinery/nanite_chamber/proc/inject_nanites()
	...
	playsound(src, 'surfshack13/nanites/sound/nanite_install.wav', 50)
...
/obj/machinery/nanite_chamber/proc/remove_nanites()
	...
	playsound(src, 'surfshack13/nanites/sound/nanite_install_short.mp3', 50)
...
/obj/machinery/nanite_chamber/close_machine(atom/movable/target, density_to_set = TRUE)
	if(!state_open)
		return FALSE
	playsound(src, 'surfshack13/nanites/sound/nanite_chamber.wav', 40)
	return ..()
